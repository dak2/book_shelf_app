...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { book_id: @library.book_id, content: @library.content, name: @library.name } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { book_id: @library.book_id, content: @library.content, name: @library.name } }
